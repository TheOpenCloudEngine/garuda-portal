...
import org.uengine.util.MutableInteger;
...
//	        System.out.println("check log file .. " + filePath);
	        ...
	        //테넌트별.
	        Map<String, MutableInteger> usageMap = new HashMap<String, MutableInteger>();
            ...
            while (line != null) {
                ...
                if(p > 0) {
                    ...
                    try {
                        ...
                        MutableInteger qty1 = usageMap.get(id1);
	                    if(qty1 == null) {
		                    qty1 = new MutableInteger();
